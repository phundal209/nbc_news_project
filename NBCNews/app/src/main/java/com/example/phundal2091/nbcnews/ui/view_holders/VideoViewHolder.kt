 ...
 */
class VideoViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView), IBaseViewHolder {
    ...
    val playVideo : TextView = itemView?.findViewById<TextView>(R.id.playVideo) as TextView
}